...
export const journeyTemplate: StageTemplate[] = [
  ...
  },
  {
    ...
    milestones: [
      ...
      { id: "bd-g3", title: "Review & approve your Google Ads keywords", detail: "These are the searches we'll put you in front of — the exact phrases people type when they're ready to call someone like you. Check they match the work you actually want, and tell us anything to add or cut.", hasEditableContent: true, notePrompt: "Any keywords to add, or work you don't want to bid on?", notePlaceholder: "e.g. add \"emergency hot water\", drop anything about commercial jobs", channels: ["google"] },
